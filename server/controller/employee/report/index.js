...
router.use(cors());
let reportController = require('./report.Controller');

// version 1.0

router.post('/daily',reportController.daily);
router.post('/monthly',reportController.monthly);
router.post('/yearly',reportController.yearly);
